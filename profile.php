...
if ($getFromU->loggedIn() === false || $profileId == 0) {
...
// call followUser() method from follow class when follow button is clicked
if(isset($_POST['follow'])) {
	$followResult = $getFromF->followUser($user_id, $profileId);
	header('Refresh:0'); 
}

// call unfollowUser() method from follow class when unfollow button is clicked
if(isset($_POST['unfollow'])) {
	$followResult = $getFromF->unfollowUser($user_id, $profileId);
	header('Refresh:0'); 
}

// search //
if (isset($_POST['search'])) {
	$searchUsername = $getFromU->checkInput($_POST['searchUsername']);
    $searchUserURL = $getFromU->searchByUsername($searchUsername);
			...
			<ul>
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="profile.php?username=<?php echo $profileData->username; ?>"><?php echo $profileData->username; ?></a></li>
